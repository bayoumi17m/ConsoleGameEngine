/*
The inspiration for this came from a man on youtube called Jadvix9, I believe.
Rather than focusing on the gui, this will allow me to more quickly toy around
with games or other features without a whole lot of set up (also without having
a fancy GPU or a lot of setup using openGL or an actual engine).
*/
...
public:
    void Start()
    {
        ...
        // Star the thread
        thread t = thread(&ConsoleGameEngine::GameThread, this);
...
atomic<bool> ConsoleGameEngine::m_bAtomActive(false);
condition_variable ConsoleGameEngine::m_cvGameFinished;
mutex ConsoleGameEngine::m_muxGame;